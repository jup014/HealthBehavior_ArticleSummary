...
6. EMA 사용 시의 도전(challenge):
    1. 특정 구성개념(Construct)을 측정하기 위한 질문항목의 타당도(Validity)를 신중하게 고려해야 함. 특히 유념해야 할 것은 구성개념 타당도(Construct Validity)와 내용 타당도(Content Validity)임.
        - **구성개념 타당도** : 측정하고자 하는 구성개념과 측정도구가 얼마나 상관관계가 있는지[27]
        - **내용 타당도** : 측정하고자 하는 구성개념의 전체적인 측면을 빠짐없이 대변하는지[28]
