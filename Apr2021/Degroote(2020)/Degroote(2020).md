...
6. EMA 사용 시의 도전(challenge):
    1. 특정 요소(Construct)를 측정하기 위한 질문항목의 타당도(Validity)를 신중하게 고려해야 함. 특히 유념해야 할 것은 구성요소 타당도(Construct Validity)와 내용 타당도(Content Validity)임.
        - **구성요소 타당도** : 측정하고자 하는 construct와 측정도구가 얼마나 상관관계가 있는지[27]
        - **내용 타당도** : 측정하고자 하는 construct의 전체적인 측면을 빠짐없이 대변하는지[28]
    2. 내용 타당도는 자주 빠뜨리지만, 가장 중요한 유형의(Quintessential) 타당도임. 이 리뷰는 내용타당도에 집중함
...
* 주요사례 : 55%의 연구가 모든 질문항목을 보고하였음. 15%는 예만 제시. 25%는 측정결과로부터 계산된 Construct만 보고
...
* 주요 평가항목은 다음과 같음
    1. **중요성/관련성(relevance)** : 관심대상인 Construct에 있어 중요한가? 목표 인구집단에서 유효한가? 관심대상 맥락에서 유효한가? 응답 선택지가 적절한가? 회상기간이 적절한가?
